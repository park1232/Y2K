					...
					<div class="main-paper">
						<div class="main-wrap">
							...
							<div class="main">
								...
								<div id="boardMain"
									onclick="location.href='${contextPath}/boardList.bo?userNo=${userNo}'">Y2K
									WORLD</div>
								<div id="writeStyle"
									<c:if test="${ loginUser.userNo eq userNo }">style="display:none;"</c:if>>
									<i class="fas fa-edit"
										onclick="location.href='${contextPath}/boardWrite.bo?userNo=${userNo}'"></i>
								</div>
								...
								<br>
								<ul>
									<li><c:url var="back" value="${loc}">
											<c:param name="page" value="${pi.currentPage - 1}"></c:param>
											<c:param name="userNo" value="${userNo}" />
										</c:url> <a class="way" href="${back}">◀</a></li>


									<li><c:forEach begin="${pi.startPage}" end="${pi.endPage}"
											var="p">
									...
									<li><c:url var="next" value="${loc}">
											<c:param name="page" value="${pi.currentPage + 1}"></c:param>
											<c:param name="userNo" value="${userNo}" />
										</c:url> <a class="way" href="${next}">▶</a></li>
								</ul>
								<br>
								...
								<p class="p">
									Web Site Shortcuts. <a href="https://cyworld.com"
										target="_blank" id="cyLink">See cyworld MainPage</a>.
								</p>
							</div>
