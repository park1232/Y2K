							...
							<div class="main">
								...
								<form id="detailForm">
									...
									<table>
										<thead>
											<tr id="titlebar" style="text-align: center;">
												...
												<th width="50px"
													style="border-right: 1px dashed rgb(11, 82, 0);">제목</th>
												<td>${b.boardTitle}</td>
												<th width="50px"
													style="border-right: 1px dashed rgb(11, 82, 0);">조회수</th>
												<td width="50px">${b.boardCount}</td>
												<th width="50px"
													style="border-right: 1px dashed rgb(11, 82, 0);">작성자</th>
									...
									<div id="boardContent">
										...
										<br> <br>
										<div id="good">
											<span hidden="hidden">${b.boardNo}</span><i id="likeButton"
										...
										<br> <br> <span class="sns"> <span
											class="facebook"> <a href="#n"
												onclick="fn_sendFB('facebook');return false;" id="facebook"
												target="_self" title="페이스북 새창열림"><img
													src="../resources/img/icon-facebook.png" width="30px"></a>
										</span> <span class="twitter"> <a href="#n"
												onclick="fn_sendFB('twitter');return false;" id="twitter"
												target="_self" title="트위터 새창열림"><img
													src="../resources/img/icon-twitter.png" width="30px"></a>
										</span> <span class="band"> <a href="#n"
												onclick="fn_sendFB('band');return false;" id="band"
												target="_self" title="네이버밴드 새창열림"><img
													src="../resources/img/icon-line.png" width="30px"></a>
										</span>
										</span>
										<div class="scrollbar">
											<a href="#up"><i class="fa-solid fa-circle-up"></i></a><br>
											<br>
										...
										<div id="ViewForm">
											<button type="button" id="updateForm"
												<c:if test="${ loginUser.userNo ne b.boardWriter }">style="display:none;"</c:if>>수정하기</button>
											<button type="button" id="deleteForm"
												<c:if test="${ loginUser.userNo ne b.boardWriter }">style="display:none;"</c:if>>삭제하기</button>
											<button type="button" id="boardListBack"
												onclick="location.href='${contextPath}/boardList.bo?userNo=${userNo}'">목록으로</button>
										</div>
										<%-- </c:if> --%>
										<br>
									</div>
									...
									<div id="replyDiv">
										...
										<table>
											<thead>
												<tr>
													<th colspan="2"><textarea rows="3" cols="50"
															id="replyContent" style="resize: none;"
															placeholder='일촌에게 댓글을 작성해보세요!'></textarea></th>
													<th>
														<div id="replyButton">
															<button class="button btnBorder btnOrange"
																id="replySubmit" type="button">등록</button>
														</div>
													</th>
												</tr>
											</thead>
													...
													<tr>
														...
														<td>&nbsp;&nbsp;
															<button type="button" class="deleteReply"
																...
																<c:if test="${ loginUser.nickName ne r.nickName }">style="display:none;"</c:if>>
																<i class="fas fa-trash-alt"></i>
															</button> <input type="hidden" value="${r.replyNo}" name="replyNo"
															class="replyNo">
														</td>
													</tr>
												</c:forEach>
