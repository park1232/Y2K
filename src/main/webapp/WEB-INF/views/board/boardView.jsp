							...
							<div class="main">
								...
								<form id="detailForm">
									...
									<div id="boardContent">
										...
										</span> <span class="linkcopy"> <a href="#n"
												onclick="fn_sendFB('linkcopy');return false;" id="likecopy"
												target="_self" title="링크 복사"><img
													src="../resources/img/icon-link.png" width="30px"></a>
										</span> <span class="button gray medium"><a href="#"
